...
class CityPanel {
    ...
    async show() {
        ...
        this.panel = vscode.window.createWebviewPanel('codeToCity', '[C2C] Code-to-City', { viewColumn: vscode.ViewColumn.Beside, preserveFocus: true }, { enableScripts: true, retainContextWhenHidden: true });
    ...
    setBuildFailure(errors) {
        if (!this.panel || !this.currentSolution) {
            return;
        }
